    ...
    if(!empty($_POST['pseudo'])){
       ...
       if(!empty($_POST['nouveauEmail'])){
        ...
        if ($errors === 0) {
            ...
            sql("UPDATE `membre` SET `pseudo` = '$pseudo', `nom` = '$nom', `prenom` = '$prenom', `telephone` = '$telephone', `email` = '$nouveauEmail' WHERE '$id_membre' = id_membre"
        );
...
<div class="container-fluid titre1 " style="width:100vw">
    ...
    <div class="table-responsive-lg shadow-sm text-center table-hover">
        <table>
            ...
            <div class="col-md-6">
                <hr class="mb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" id="pseudo" name="pseudo" class="form-control" value="<?php echo $membre['pseudo'] ?>">
                    </div>
            </div>
            <div class="col-md-6">
                <hr class="mb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" id="email" name="email" class="form-control" value="<?php echo $membre['email'] ?>">
                    </div>
            </div>
        </div>
        <div class="row">
